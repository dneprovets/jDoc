 ...
 * @private
 */
RTF.prototype._parseControlWord = {
    value (text, index, parseParams, parseResult) {
        var match,
            matchedPart,
            clearedControlWord,
        ...
        if (this._ignoreControlWordGroups[clearedControlWord]) {
            ...
            if (controlWordsParsers[clearedControlWord]) {
                controlWordParserData = {
                ...
                controlWordParseResult = controlWordsParsers[clearedControlWord].call(this, controlWordParserData);
